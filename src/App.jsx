...
import {
  ...
  Headphones, Eye, Waves, RefreshCw, Zap, Move, Thermometer
} from "lucide-react";
import {
...
const STUDIO_CONFIG = {
  name: "SEALEVEL",
  subtitle: "HOT YOGA",
  tagline: "Seattle's Original. Since 1996.",
  logoMark: "S",
  description: "The longest running Bikram method studio in Seattle. 26 postures. 2 breathing exercises. 105-107 degrees. 40% humidity. Beautiful, clean, light-filled. Since 1996.",
  heroLine1: "THE",
  heroLine2: "ORIGINAL",
  address: { street: "215 N 36th St", city: "Seattle", state: "WA", zip: "98103" },
  phone: "(206) 547-0188",
  email: "info@sealevelhotyoga.com",
  neighborhood: "Fremont, Seattle",
  website: "https://sealevelhotyoga.com",
  social: { instagram: "@sealevelhotyoga" },
  locations: [{ name: "Fremont Studio", type: "hot yoga" }],
  theme: {
    accent:     { h: 205, s: 52, l: 44 },
    accentAlt:  { h: 35,  s: 55, l: 52 },
    warning:    { h: 15,  s: 60, l: 52 },
    primary:    { h: 210, s: 22, l: 10 },
    surface:    { h: 205, s: 8,  l: 97 },
    surfaceDim: { h: 200, s: 6,  l: 93 },
  },
  features: {
    workshops: true, retreats: true, soundBaths: false, teacherTrainings: false,
    practiceTracking: true, communityFeed: true, guestPasses: true, milestones: true,
    multiLocation: false, bikram: true, hotRoom: true,
  },
  classCapacity: 30,
...
const STUDIO_IMAGES = {
  home: "https://i.ytimg.com/vi/atYGTba55Ho/maxresdefault.jpg",
  classes: "https://i.ytimg.com/vi/AtW1jyegLk4/maxresdefault.jpg",
  schedule: "https://i.ytimg.com/vi/shZR85rJQTc/maxresdefault.jpg",
  practice: "https://i.ytimg.com/vi/dsC3tlqyk1s/maxresdefault.jpg",
  community: "https://i.ytimg.com/vi/5qKF4LhtBBs/maxresdefault.jpg",
  teachers: "https://i.ytimg.com/vi/aLd4XmReeM4/maxresdefault.jpg",
  events: "https://i.ytimg.com/vi/glbRL6xNu8E/maxresdefault.jpg",
  membership: "https://i.ytimg.com/vi/bRr3Bxt5GAY/maxresdefault.jpg",
};
const GRADIENTS = {
  home: `linear-gradient(135deg, hsl(205,52%,26%) 0%, hsl(210,22%,12%) 100%)`,
  classes: `linear-gradient(135deg, hsl(35,55%,28%) 0%, hsl(205,35%,18%) 100%)`,
  schedule: `linear-gradient(135deg, hsl(210,25%,22%) 0%, hsl(205,52%,18%) 100%)`,
  practice: `linear-gradient(135deg, hsl(205,42%,26%) 0%, hsl(210,22%,14%) 100%)`,
  community: `linear-gradient(135deg, hsl(15,60%,28%) 0%, hsl(210,22%,14%) 100%)`,
  teachers: `linear-gradient(135deg, hsl(205,52%,28%) 0%, hsl(35,28%,18%) 100%)`,
  events: `linear-gradient(135deg, hsl(35,55%,26%) 0%, hsl(205,28%,16%) 100%)`,
  membership: `linear-gradient(135deg, hsl(205,52%,24%) 0%, hsl(15,30%,18%) 100%)`,
};
...
const T = {
  ...
  text: "#101820", textMuted: "#486070", textFaint: "#788898",
  border: "#c4d4dc", borderLight: "#dce8f0",
};
...
const TEACHERS = [
  { id: "t1", firstName: "Kevin", lastName: "Cooke", role: "Co-Owner & Lead Teacher", certs: ["Bikram Certified", "28+ Years Teaching"], specialties: ["Bikram 90", "Bikram 60", "Hot Yoga"], yearsTeaching: 28, bio: "Kevin has co-owned Sealevel since 1996, making it the longest running Bikram method studio in Seattle. His teaching embodies decades of practice with kindness, skill, intelligence, compassion, and love.", photo: "" },
  { id: "t2", firstName: "Kathy", lastName: "Allen", role: "Co-Owner & Teacher", certs: ["Bikram Certified"], specialties: ["Bikram 90", "Bikram 60", "Yin"], yearsTeaching: 28, bio: "Kathy brings warmth and precision to every class. Together with Kevin, she has built a community-focused studio where anyone from beginner to advanced practitioner can take their practice to the next level.", photo: "" },
  { id: "t3", firstName: "Kim", lastName: "Torres", role: "Teacher", certs: ["Bikram Certified"], specialties: ["Bikram 90", "Bikram 60"], yearsTeaching: 15, bio: "Kim is praised as supportive without being pushy. Her detailed instruction helps students safely explore every one of the 26 postures. Students confidently call Sealevel the best Bikram studio in the greater Seattle area because of teachers like Kim.", photo: "" },
  { id: "t4", firstName: "Maya", lastName: "Chen", role: "Teacher", certs: ["RYT-200", "Yin Certified"], specialties: ["Yin", "Bikram 60"], yearsTeaching: 8, bio: "Maya teaches Yin yoga at Sealevel — the still counterpoint to the heated Bikram practice. Her long-held floor postures target connective tissue, hips, and spine, releasing tension that 105-degree classes cannot reach.", photo: "" },
  { id: "t5", firstName: "Alex", lastName: "Park", role: "Teacher", certs: ["Bikram Certified"], specialties: ["Bikram 90", "Bikram 60"], yearsTeaching: 10, bio: "Alex brings dynamic energy and detailed alignment cues to the hot room. His classes are known for precise instruction that helps students understand the mechanics behind every posture.", photo: "" },
];

const TODAYS_FOCUS = {
  id: "focus-today", date: today, name: "Bikram 90", type: "BIKRAM90", style: "Bikram 90", temp: "105-107\u00b0F / 40% Humidity", duration: 90,
  description: "The original. 26 postures and 2 breathing exercises in 90 minutes at 105-107 degrees with 40% humidity. Works every muscle, joint, ligament, and tendon. Stimulates internal organs, glands, and nerves. The foundation since 1996.",
  intention: "Same owners. Same teachers. Same yoga you love. Since 1996.",
  teacherTip: "105-107 degrees with 40% humidity. Hydrate all day. Dress lightly. Leave phones, watches, and keys in lockers. Stay in the room. Do not miss savasana.",
};

const PAST_PRACTICES = [
  { id: "p-y1", date: offsetDate(-1), name: "Bikram 60", type: "BIKRAM60", style: "Bikram 60", temp: "105-107\u00b0F", duration: 60, description: "The same 26-posture sequence in an abbreviated 60-minute format. One set of each posture. When an hour is what fits your schedule, the practice still delivers.", intention: "The tradition does not need 90 minutes to change you. But it helps." },
  { id: "p-y2", date: offsetDate(-2), name: "Yin", type: "YIN", style: "Yin", temp: "Room Temp", duration: 60, description: "Long-held passive floor poses targeting hips, pelvis, inner thighs, and spine. Postures held up to five minutes. Muscles relaxed. Connective tissue releases. Energetic flow restored through the body meridians.", intention: "Where the heat cannot reach, stillness can." },
  { id: "p-y3", date: offsetDate(-3), name: "Bikram 90", type: "BIKRAM90", style: "Bikram 90", temp: "105-107\u00b0F / 40% Humidity", duration: 90, description: "Two sets of each posture. Two breathing exercises. The full traditional class that has been the foundation of this studio for nearly three decades.", intention: "Twenty-six postures. Thousands of students. One tradition." },
];

const UPCOMING_PRACTICE = { id: "p-tmrw", date: offsetDate(1), name: "Bikram 60", type: "BIKRAM60", style: "Bikram 60", temp: "105-107\u00b0F", duration: 60, description: "The abbreviated Bikram format. Same sequence, same heat, one set per posture. Ideal for busy schedules or as a complement to the full 90-minute practice.", intention: "An hour of discipline. A lifetime of change." };

const CLASSES_TODAY = [
  { id: "cl1", time: "05:30", type: "Bikram 90", coach: "Kevin Cooke", capacity: 30, registered: 22, waitlist: 0, location: "Fremont Studio" },
  { id: "cl2", time: "09:00", type: "Bikram 60", coach: "Kim Torres", capacity: 30, registered: 24, waitlist: 0, location: "Fremont Studio" },
  { id: "cl3", time: "12:00", type: "Bikram 90", coach: "Alex Park", capacity: 30, registered: 20, waitlist: 0, location: "Fremont Studio" },
  { id: "cl4", time: "16:30", type: "Yin", coach: "Maya Chen", capacity: 30, registered: 18, waitlist: 0, location: "Fremont Studio" },
  { id: "cl5", time: "18:00", type: "Bikram 90", coach: "Kathy Allen", capacity: 30, registered: 28, waitlist: 3, location: "Fremont Studio" },
];

const WEEKLY_SCHEDULE = [
  { day: "Monday", classes: [{ time: "05:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:00", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Bikram 90", coach: "Alex" }, { time: "16:30", type: "Yin", coach: "Maya" }, { time: "18:00", type: "Bikram 90", coach: "Kathy" }] },
  { day: "Tuesday", classes: [{ time: "05:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:00", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Bikram 90", coach: "Alex" }, { time: "16:30", type: "Yin", coach: "Maya" }, { time: "18:00", type: "Bikram 90", coach: "Kathy" }] },
  { day: "Wednesday", classes: [{ time: "09:00", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Bikram 90", coach: "Alex" }, { time: "16:30", type: "Yin", coach: "Maya" }, { time: "18:00", type: "Bikram 90", coach: "Kathy" }] },
  { day: "Thursday", classes: [{ time: "05:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:00", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Bikram 90", coach: "Alex" }, { time: "16:30", type: "Yin", coach: "Maya" }, { time: "18:00", type: "Bikram 90", coach: "Kathy" }] },
  { day: "Friday", classes: [{ time: "05:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:00", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Bikram 90", coach: "Alex" }, { time: "16:30", type: "Yin", coach: "Maya" }, { time: "18:00", type: "Bikram 90", coach: "Kathy" }] },
  { day: "Saturday", classes: [{ time: "07:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:30", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Yin", coach: "Maya" }, { time: "16:00", type: "Bikram 90", coach: "Alex" }] },
  { day: "Sunday", classes: [{ time: "07:30", type: "Bikram 90", coach: "Kevin" }, { time: "09:30", type: "Bikram 60", coach: "Kim" }, { time: "12:00", type: "Yin", coach: "Maya" }, { time: "16:00", type: "Bikram 90", coach: "Alex" }] },
];

const COMMUNITY_FEED = [
  { id: "cf1", user: "Sarah T.", milestone: "500 Classes", message: "Five hundred classes since I found Sealevel in 2008. Kevin, Kathy, and Kim have been here through every one. This is not just a studio. It is family.", date: today, celebrations: 52 },
  { id: "cf2", user: "James R.", milestone: "First 90-Min", message: "Ninety minutes. 105 degrees. 40% humidity. 26 postures. I did not think I could make it. I did. Kim was right there with me the entire time.", date: today, celebrations: 28 },
  { id: "cf3", user: "Mia L.", milestone: "30-Day Streak", message: "Thirty consecutive days at Sealevel. The 5:30am class with Kevin before sunrise. My body has completely transformed. My mind even more so.", date: offsetDate(-1), celebrations: 34 },
  { id: "cf4", user: "David K.", milestone: "First Yin", message: "After months of 105-degree practice, Maya guided me through yin. Where the heat cannot reach, stillness can. Both practices are essential.", date: offsetDate(-2), celebrations: 20 },
];

const MILESTONE_BADGES = {
  "First Class": { icon: Thermometer, color: T.accent },
  "10 Classes": { icon: Wind, color: T.accent },
  "50 Classes": { icon: Mountain, color: T.accent },
  "100 Classes": { icon: Star, color: T.success },
  "500 Classes": { icon: Award, color: T.success },
  "7-Day Streak": { icon: Flame, color: T.warning },
  "30-Day Streak": { icon: Sparkles, color: T.warning },
  "First Yin": { icon: Moon, color: "#8b5cf6" },
  "5 Year Member": { icon: Heart, color: T.accent },
};

const EVENTS = [
  { id: "ev1", name: "26-Posture Clinic with Kevin", date: "2026-05-17", startTime: "13:00", type: "Workshop", description: "A 3-hour deep dive into the 26 postures with Kevin Cooke. Alignment, modifications, and the tradition behind every pose. Nearly 30 years of teaching distilled into one afternoon.", fee: 60, maxParticipants: 25, registered: 18, status: "Registration Open" },
  { id: "ev2", name: "Yin + Breathwork Workshop", date: "2026-06-07", startTime: "14:00", type: "Workshop", description: "Maya leads a 2-hour Yin workshop exploring meridian theory and breathwork. Long-held postures paired with pranayama for deep energetic release.", fee: 45, maxParticipants: 25, registered: 12, status: "Registration Open" },
  { id: "ev3", name: "Sealevel Anniversary: 30 Years", date: "2026-10-01", startTime: "09:00", type: "Community Event", description: "Celebrating 30 years of hot yoga in Seattle. Special class with Kevin and Kathy. Community gathering after. Three decades of sweat, growth, and family.", fee: 0, maxParticipants: 40, registered: 28, status: "Open" },
];

const MEMBERSHIP_TIERS = [
  { id: "m0", name: "Student Intro: 2 Weeks", type: "intro", price: 59, period: "2 weeks", features: ["Unlimited classes for 14 days", "Free water included", "Mat, towel, parking rental available", "New students only"], popular: false },
  { id: "m1", name: "Drop-In", type: "drop-in", price: 25, period: "per class", features: ["Single class credit", "Any class type", "Mat rental available"], popular: false },
  { id: "m2", name: "10 Class Punchcard", type: "pack", price: 200, period: "10 classes", features: ["$20 per class", "Valid for 1 year", "Any class type"], popular: false },
  { id: "m3", name: "20 Class Punchcard", type: "pack", price: 360, period: "20 classes", features: ["$18 per class", "Valid for 1 year", "Best per-class value"], popular: false },
  { id: "m4", name: "Unlimited Monthly", type: "unlimited", price: 135, period: "/month", features: ["Unlimited all classes", "Bikram 60, Bikram 90, Yin", "Mat/towel rental available", "Auto-renewing"], popular: true },
];

const ANNOUNCEMENTS = [
  { id: "a1", title: "Student Intro: 2 Weeks for $59", message: "Unlimited hot yoga. Free water. Mat, towel, and parking rental included. The original since 1996.", type: "celebration", pinned: true },
  { id: "a2", title: "30th Anniversary: October 2026", message: "Three decades of hot yoga in Seattle. Special celebration class with Kevin and Kathy. Save the date.", type: "info", pinned: false },
];

const MEMBERS_DATA = [
  { id: "mem1", name: "Sarah Torres", email: "sarah@email.com", membership: "Unlimited Monthly", status: "active", joined: "2008-03-01", checkIns: 1248, lastVisit: today },
  { id: "mem2", name: "James Reeves", email: "james@email.com", membership: "10 Class Punchcard", status: "active", joined: "2026-02-01", checkIns: 6, lastVisit: offsetDate(-2) },
  { id: "mem3", name: "Mia Lee", email: "mia@email.com", membership: "Unlimited Monthly", status: "active", joined: "2024-06-01", checkIns: 286, lastVisit: today },
  { id: "mem4", name: "David Kim", email: "david@email.com", membership: "20 Class Punchcard", status: "active", joined: "2025-08-01", checkIns: 14, lastVisit: offsetDate(-1) },
  { id: "mem5", name: "Nicole Park", email: "nicole@email.com", membership: "Unlimited Monthly", status: "frozen", joined: "2023-04-01", checkIns: 342, lastVisit: offsetDate(-30) },
  { id: "mem6", name: "Ryan Chen", email: "ryan@email.com", membership: "Student Intro", status: "active", joined: "2026-04-10", checkIns: 5, lastVisit: offsetDate(-1) },
];

const ADMIN_METRICS = { activeMembers: 196, memberChange: 8, todayCheckIns: 56, weekCheckIns: 336, monthlyRevenue: 26400, revenueChange: 6.2, renewalRate: 92.4, workshopRevenue: 2600 };

const ADMIN_CHARTS = {
  attendance: [
    { day: "Mon", total: 54, avg: 11 }, { day: "Tue", total: 48, avg: 10 },
    { day: "Wed", total: 42, avg: 11 }, { day: "Thu", total: 50, avg: 10 },
    { day: "Fri", total: 40, avg: 10 }, { day: "Sat", total: 54, avg: 14 },
    { day: "Sun", total: 48, avg: 12 },
  ],
  revenue: [
    { month: "Sep", revenue: 22400 }, { month: "Oct", revenue: 23200 },
    { month: "Nov", revenue: 23800 }, { month: "Dec", revenue: 22000 },
    { month: "Jan", revenue: 25000 }, { month: "Feb", revenue: 25800 },
    { month: "Mar", revenue: 26400 },
  ],
  classPopularity: [
    { name: "5:30 AM", pct: 74 }, { name: "9:00 AM", pct: 82 },
    { name: "12:00 PM", pct: 68 }, { name: "4:30 PM", pct: 62 },
    { name: "6:00 PM", pct: 94 },
  ],
  membershipBreakdown: [
    { name: "Unlimited Monthly", value: 82, color: T.accent },
    { name: "20 Punchcard", value: 28, color: T.success },
    { name: "10 Punchcard", value: 38, color: T.warning },
    { name: "Drop-In / Intro", value: 48, color: T.textMuted },
  ],
};
...
function TeacherAvatar({ teacher, size = 56 }) {
  ...
  return (
    <div style={{ width: size, height: size, borderRadius: size > 48 ? 14 : 10, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Arvo', serif", fontSize: size * 0.38, color: "#fff", flexShrink: 0, fontWeight: 600 }}>
...
function SectionHeader({ title, linkText, linkPage }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12, padding: "0 16px" }}>
      <h2 style={{ fontFamily: "'Arvo', serif", fontSize: 24, margin: 0, fontWeight: 600 }}>{title}</h2>
    ...
    <div onClick={onToggle} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderLeft: `4px solid ${typeColors[practice.type] || T.accent}`, borderRadius: 12, padding: isFeatured ? "18px 18px" : "14px 16px", cursor: onToggle ? "pointer" : "default" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: isExpanded ? 10 : 0 }}>
        <div>
          ...
          <h3 style={{ fontFamily: "'Arvo', serif", fontSize: isFeatured ? 26 : 20, margin: 0, color: T.text, fontWeight: 600 }}>{practice.name}</h3>
        </div>
...
function StatBox({ label, value }) {
  return (
    <div style={{ background: T.bgDim, borderRadius: 8, padding: "10px 12px", textAlign: "center" }}>
      ...
      <p style={{ fontFamily: "'Arvo', serif", fontSize: 22, color: T.text, margin: 0, fontWeight: 700 }}>{value}</p>
    </div>
  );
}
...
function AdminCard({ title, children }) {
  return (
    <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
      <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 18, color: "#111827", margin: "0 0 14px", fontWeight: 600 }}>{title}</h3>
      {children}
    </div>
  );
}
    ...
    <div>
            ...
            return (
              <div key={c.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 48 }}>
                  <span style={{ fontFamily: "'Arvo', serif", fontSize: 22, color: T.text, fontWeight: 600 }}>{fmtTime(c.time).split(":")[0]}</span>
      ...
      {ANNOUNCEMENTS.length > 0 && (
        <section style={{ marginTop: 28, padding: "0 16px" }}>
          <h2 style={{ fontFamily: "'Arvo', serif", fontSize: 24, margin: "0 0 12px", fontWeight: 600 }}>Announcements</h2>
      ...
      <section style={{ padding: "16px 16px 8px", marginTop: 20 }}>
        <div style={{ background: `linear-gradient(165deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 16, padding: "24px 20px", color: "#fff", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 24, margin: "0 0 6px", fontWeight: 600 }}>New to Sealevel Hot Yoga?</h3>
            <p style={{ fontSize: 13, color: "#b8a898", margin: "0 0 16px", lineHeight: 1.5 }}>Student intro: 2 weeks for $59. Free water. Since 1996.</p>
            <button onClick={() => {}} style={{ display: "inline-flex", alignItems: "center", gap: 6, padding: "10px 20px", borderRadius: 8, border: "none", background: T.accent, color: "#fff", fontFamily: "'Arvo', serif", fontSize: 15, cursor: "pointer", fontWeight: 600 }}>View Memberships <ChevronRight size={16} /></button>
          </div>
        </div>
      </section>
    </div>
...
function ClassesPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.classes} title="Classes" subtitle="Bikram 60, Bikram 90, and Yin. 26 postures. 105-107 degrees." />
      ...
      <div style={{ padding: "16px 16px 0" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
          {WEEKLY_SCHEDULE[selectedDay]?.classes.map((cls, i) => {
            const isSpecial = cls.type.includes("Yin");
            return (
              <div key={i} style={{ display: "flex", alignItems: "center", gap: 12, padding: "14px 16px", background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12 }}>
                <div style={{ textAlign: "center", minWidth: 54 }}>
                  <span style={{ fontFamily: "'Arvo', serif", fontSize: 16, color: T.text, fontWeight: 600 }}>{fmtTime(cls.time)}</span>
                </div>
                <div style={{ flex: 1 }}>
                  ...
                  <p style={{ fontSize: 11, color: T.textMuted, margin: "2px 0 0" }}>{cls.coach} — Fremont Studio</p>
                </div>
                <button onClick={() => openReservation({ id: `sched-${selectedDay}-${i}`, time: cls.time, type: cls.type, coach: cls.coach || "TBD", location: "Fremont Studio", capacity: isSpecial ? STUDIO_CONFIG.specialtyCapacity : STUDIO_CONFIG.classCapacity, registered: Math.floor(Math.random() * 10) + 15, waitlist: 0, dayLabel: dayNames[selectedDay] })} style={{ padding: "8px 14px", borderRadius: 8, border: "none", fontSize: 12, fontWeight: 600, cursor: "pointer", background: T.accent, color: "#fff" }}>Reserve</button>
              </div>
            );
          })}
        </div>
    ...
    <div>
      ...
      <div style={{ padding: "16px 16px 0" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 8, marginBottom: 20 }}>
          {[
            ...
            <div key={i} style={{ background: s.ghost, border: `1px solid ${s.bdr}`, borderRadius: 12, padding: "14px 10px", textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "'Arvo', serif", fontSize: 28, fontWeight: 700, color: T.text }}>{s.val}</div>
        ...
        {activeTab === "log" && (
          <div style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 12, padding: 20 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
              ...
              <button onClick={() => { setSaved(true); setTimeout(() => setSaved(null), 2000); setReflection({ energy: 4, focus: 4, notes: "" }); }} style={{ padding: "12px 0", borderRadius: 8, border: "none", fontWeight: 700, cursor: "pointer", background: T.accent, color: "#fff", fontFamily: "'Arvo', serif", fontSize: 17 }}>
        ...
        <div style={{ marginTop: 24 }}>
          <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 22, margin: "0 0 12px", fontWeight: 600 }}>Recent Practice</h3>
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            {[
              { date: today, name: "Bikram 90", result: "90 min", badge: "hot", icon: Sun, color: T.warning, ghost: T.warningGhost },
              { date: offsetDate(-1), name: "Bikram 60", result: "60 min", badge: "bikram", icon: Flame, color: T.accent, ghost: T.accentGhost },
              { date: offsetDate(-2), name: "Yin", result: "60 min", badge: "yin", icon: Moon, color: "#8b5cf6", ghost: "#8b5cf610" },
            ].map((h, i) => (
      ...
      <div style={{ padding: "16px 16px 0" }}>
        {STUDIO_CONFIG.features.guestPasses && (
          <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, borderRadius: 14, padding: "18px", marginBottom: 20, color: "#fff" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}><Gift size={20} color={T.accent} /><h3 style={{ fontFamily: "'Arvo', serif", fontSize: 18, margin: 0, fontWeight: 600 }}>Guest Passes</h3></div>
            ...
            return (
              <div key={item.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, padding: "16px 18px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 10 }}>
                  <div style={{ width: 40, height: 40, borderRadius: "50%", background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Arvo', serif", fontSize: 16, color: "#fff", fontWeight: 700, flexShrink: 0 }}>{item.user[0]}</div>
...
function TeachersPage() {
  ...
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.teachers} title="Teachers" subtitle="Seattle's original hot yoga since 1996. Bikram method. Fremont." />
      <div style={{ padding: "16px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
      ...
      <div style={{ padding: "16px 16px 0", display: "flex", flexDirection: "column", gap: 12 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: T.bgCard, border: `1px solid ${tier.popular ? T.accent : T.border}`, borderRadius: 14, padding: "20px 18px", position: "relative", overflow: "hidden" }}>
            ...
            <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 22, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ display: "flex", alignItems: "baseline", gap: 4, marginBottom: 12 }}>
              <span style={{ fontFamily: "'Arvo', serif", fontSize: 38, color: T.accent, fontWeight: 700 }}>${tier.price}</span>
            ...
            <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Arvo', serif", background: tier.popular ? T.accent : T.bg, color: "#fff" }}>Get Started</button>
          </div>
        ))}
      </div>
    </div>
...
function EventsPage() {
  return (
    <div>
      <PageHero image={STUDIO_IMAGES.events} title="Events" subtitle="Posture clinics, workshops, retreats, and community events" />
      <div style={{ padding: "16px 16px 0" }}>
        {EVENTS.map(ev => (
          <div key={ev.id} style={{ background: T.bgCard, border: `1px solid ${T.border}`, borderRadius: 14, overflow: "hidden", marginBottom: 16 }}>
            <div style={{ background: `linear-gradient(135deg, ${T.bg}, hsl(30,20%,14%))`, padding: "20px 18px", color: "#fff" }}>
              ...
              <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 20, margin: "6px 0 4px", fontWeight: 600 }}>{ev.name}</h3>
            ...
            <div style={{ padding: "16px 18px" }}>
              ...
              <button style={{ width: "100%", padding: "12px 0", borderRadius: 8, border: "none", fontSize: 16, fontWeight: 700, cursor: "pointer", fontFamily: "'Arvo', serif", background: T.accent, color: "#fff" }}>Register Now</button>
            </div>
          </div>
        ))}
      </div>
...
function AdminDashboard() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      <div><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Dashboard</h1><p style={{ fontSize: 13, color: "#6b7280", margin: "4px 0 0" }}>Welcome back. Here is what is happening at Sealevel.</p></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 14 }}>
        {metrics.map((m, i) => (
          <div key={i} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
            ...
            <div style={{ fontFamily: "'Arvo', serif", fontSize: 30, color: "#111827", fontWeight: 700 }}>{m.value}</div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 14 }}>
        ...
        <AdminCard title="Recent Activity">
          <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
            {[{ text: "New member signup", detail: "Ryan Chen - Student Intro", time: "5 min ago", color: T.accent },{ text: "Workshop registration", detail: "Yin Workshop - David K.", time: "12 min ago", color: "#8b5cf6" },{ text: "Class waitlist full", detail: "6:00 PM Bikram 90", time: "18 min ago", color: T.success },{ text: "Payment received", detail: "Unlimited Monthly - Sarah Torres", time: "25 min ago", color: T.warning },{ text: "Guest pass redeemed", detail: "Sarah Torres's guest", time: "1 hr ago", color: "#3b82f6" }].map((a, i) => (
...
function AdminMembersPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Members</h1><CrudBar addLabel="Add Member" /></div>
...
function AdminSchedulePage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Schedule</h1><CrudBar addLabel="Add Class" /></div>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, overflow: "hidden" }}>
        <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
          ...
          <tbody>{CLASSES_TODAY.map(c => (
            <tr key={c.id} style={{ borderBottom: "1px solid #f3f4f6" }}>
              ...
              <td style={{ padding: "12px 14px", color: "#6b7280", fontSize: 12 }}>Fremont Studio</td>
...
function AdminTeachersPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Teachers</h1><CrudBar addLabel="Add Teacher" /></div>
...
function AdminEventsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Events & Workshops</h1><CrudBar addLabel="New Event" /></div>
      {EVENTS.map(ev => (
        <div key={ev.id} style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 8 }}>
              <div style={{ textAlign: "right" }}><div style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: T.accent, fontWeight: 700 }}>{ev.registered}</div><p style={{ fontSize: 11, color: "#6b7280" }}>of {ev.maxParticipants}</p></div>
              <CrudActions />
            </div>
          </div>
        </div>
...
function AdminPricingPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}><h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Pricing & Memberships</h1><CrudBar addLabel="Add Tier" /></div>
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(260px, 1fr))", gap: 14 }}>
        {MEMBERSHIP_TIERS.map(tier => (
          <div key={tier.id} style={{ background: "#fff", border: `1px solid ${tier.popular ? T.accent : "#e5e7eb"}`, borderRadius: 12, padding: 18 }}>
            ...
            <h3 style={{ fontFamily: "'Arvo', serif", fontSize: 20, color: "#111827", margin: "0 0 4px", fontWeight: 600 }}>{tier.name}</h3>
            <div style={{ fontFamily: "'Arvo', serif", fontSize: 32, color: T.accent, fontWeight: 700 }}>${tier.price}<span style={{ fontSize: 14, color: "#6b7280", fontWeight: 400 }}> {tier.period}</span></div>
...
function AdminBroadcastPage() {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Broadcast</h1>
      <div style={{ background: "#fff", border: "1px solid #e5e7eb", borderRadius: 12, padding: 18 }}>
...
function AdminSettingsPage() {
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
      <h1 style={{ fontFamily: "'Arvo', serif", fontSize: 28, color: "#111827", margin: 0, fontWeight: 600 }}>Studio Settings</h1>
        ...
        {!confirmed ? (
          <>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
              <h2 style={{ fontFamily: "'Arvo', serif", fontSize: 24, margin: 0, color: T.text, fontWeight: 600 }}>Confirm Reservation</h2>
            ...
            <div style={{ background: T.bgDim, borderRadius: 14, padding: "18px 16px", marginBottom: 20 }}>
              ...
              <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}><MapPin size={16} color={T.textMuted} /><span style={{ fontSize: 14, color: T.text }}>215 N 36th St, Fremont</span></div>
              </div>
            </div>
            <div style={{ background: T.accentGhost, border: `1px solid ${T.accentBorder}`, borderRadius: 10, padding: "12px 14px", marginBottom: 20 }}>
              ...
              <p style={{ fontSize: 12, color: "#5a5040", margin: "0 0 4px", lineHeight: 1.4 }}>105-107 degrees, 40% humidity. Leave phones in lockers. Stay in the room.. Email info@sealevelhotyoga.com to avoid fees.</p>
              <p style={{ fontSize: 12, color: "#5a5040", margin: 0, lineHeight: 1.4 }}>105-107 degrees. Free street parking. U-Park $2 passes available..</p>
            </div>
            <button onClick={() => { setConfirmed(true); onConfirm(classData.id); }} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Arvo', serif", background: isFull ? T.success : T.accent, color: "#fff", marginBottom: 8 }}>{isFull ? "Join Waitlist" : "Confirm Reservation"}</button>
          ...
          <div style={{ textAlign: "center", padding: "10px 0" }}>
            ...
            <h2 style={{ fontFamily: "'Arvo', serif", fontSize: 24, margin: "0 0 4px", color: T.text, fontWeight: 600 }}>{isFull ? "Added to Waitlist" : "You're In!"}</h2>
            ...
            <button onClick={onClose} style={{ width: "100%", padding: "14px 0", borderRadius: 10, border: "none", fontSize: 17, fontWeight: 700, cursor: "pointer", fontFamily: "'Arvo', serif", background: T.accent, color: "#fff" }}>Done</button>
          </div>
        )}
      </div>
      ...
      <div onClick={e => e.stopPropagation()} style={{ background: T.bgCard, borderRadius: "20px 20px 0 0", width: "100%", maxWidth: 390, maxHeight: "85vh", overflow: "auto", padding: "20px 20px 40px" }}>
        ...
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 48, height: 48, borderRadius: 12, background: `linear-gradient(135deg, ${T.accent}, ${T.accentDark})`, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Arvo', serif", fontSize: 20, color: "#fff", fontWeight: 700 }}>ST</div>
            <div><p style={{ fontWeight: 700, margin: 0, fontSize: 15 }}>Sarah Torres</p><p style={{ fontSize: 12, color: T.textMuted, margin: "2px 0 0" }}>Unlimited Monthly — Since Mar 2008</p></div>
          </div>
        </div>
        <div style={{ padding: "14px 0", borderBottom: `1px solid ${T.borderLight}` }}>
...
function NotificationsModal({ onClose }) {
  const notifications = [
    { id: 1, title: "Tomorrow: Bikram 60", message: "Same 26 postures. One set. 60 minutes. 105 degrees.", type: "class", time: "2 hours ago", read: false },
    { id: 2, title: "New Milestone!", message: "Mia L. hit 30-day streak. Celebrate together!", type: "community", time: "4 hours ago", read: false },
    { id: 3, title: "Class Reminder", message: "Reserved for 6:00 PM Bikram 90 with Nicole.", type: "class", time: "6 hours ago", read: true },
    { id: 4, title: "30th Anniversary Celebration", message: "Three decades of hot yoga. October 2026. Save the date.", type: "event", time: "1 day ago", read: true },
  ];
  return (
    <div onClick={onClose} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 100, display: "flex", alignItems: "flex-end", justifyContent: "center" }}>
...
export default function App({ onEnterAdmin, startInAdmin, onExitAdmin }) {
  ...
  if (isAdmin) {
    return (
      <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
        <div style={{ display: "flex", width: "100vw", height: "100vh", fontFamily: "'Poppins', system-ui, sans-serif", background: "#f5f5f5", position: "fixed", top: 0, left: 0, zIndex: 9999 }}>
          <aside style={{ width: 240, background: "#fff", borderRight: "1px solid #e5e7eb", color: "#111827", display: "flex", flexDirection: "column", flexShrink: 0 }}>
            <div style={{ padding: "16px 14px", borderBottom: "1px solid #e5e7eb" }}>
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Arvo', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
                <div><span style={{ fontFamily: "'Arvo', serif", fontSize: 16, display: "block", lineHeight: 1, fontWeight: 600, color: "#111827" }}>{STUDIO_CONFIG.name}</span><span style={{ fontSize: 8, color: "#9ca3af", textTransform: "uppercase", letterSpacing: "0.15em" }}>Admin</span></div>
              </div>
            </div>
  ...
  return (
    <AppContext.Provider value={{ page, setPage, classRegistrations, registerForClass, openReservation, feedCelebrations, celebrateFeed }}>
      <div style={{ width: 390, height: 720, position: "relative", overflow: "hidden", borderRadius: 0, background: "white", fontFamily: "'Poppins', system-ui, sans-serif" }}>
        <header style={{ position: "absolute", top: 0, left: 0, right: 0, height: 52, background: T.bg, color: "#fff", padding: "0 14px", display: "flex", alignItems: "center", justifyContent: "space-between", zIndex: 30 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <div style={{ width: 34, height: 34, borderRadius: 8, background: T.accent, display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "'Arvo', serif", fontSize: 14, color: "#fff", fontWeight: 700 }}>{STUDIO_CONFIG.logoMark}</div>
            <div style={{ display: "flex", flexDirection: "column" }}>
              <span style={{ fontFamily: "'Arvo', serif", fontSize: 18, lineHeight: 1, fontWeight: 600 }}>{STUDIO_CONFIG.name}</span>
        ...
        <div ref={contentRef} style={{ position: "absolute", top: 52, left: 0, right: 0, bottom: 60, overflowY: "auto", overflowX: "hidden", scrollbarWidth: "none", msOverflowStyle: "none", background: T.bgDim }}>
          {renderPage()}
        ...
        {showMore && (
          <div onClick={() => setShowMore(false)} style={{ position: "absolute", inset: 0, background: "rgba(0,0,0,.5)", backdropFilter: "blur(4px)", zIndex: 40 }}>
            <div onClick={e => e.stopPropagation()} style={{ position: "absolute", bottom: 68, left: 16, right: 16, background: T.bgCard, borderRadius: 16, padding: "14px 12px", boxShadow: "0 8px 32px rgba(0,0,0,.15)" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "0 6px 8px" }}><span style={{ fontFamily: "'Arvo', serif", fontSize: 20, fontWeight: 600 }}>More</span><button onClick={() => setShowMore(false)} style={{ padding: 4, borderRadius: 6, border: "none", background: "transparent", cursor: "pointer" }}><X size={18} color={T.textMuted} /></button></div>
